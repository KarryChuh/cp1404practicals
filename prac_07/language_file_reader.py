...
def main():
    ...
    languages = []
    in_file = open('/Users/zhukerui/PycharmProjects/CP1404Practicals/prac_07/languages.csv', 'r')
    in_file.readline()
    for line in in_file:
...
def using_csv():
    ...
    in_file = open('/Users/zhukerui/PycharmProjects/CP1404Practicals/prac_07/languages.csv', 'r', newline='')
    in_file.readline()
